...
Whether you get your list of generated residual matrices from calling `generate.tp.resids()` or doing manually in more detail, the mean field is reconstructed and added to each residual field to create new, full global gridded temperature and precipitation realizations. 
