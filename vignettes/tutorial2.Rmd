...
```
infileT <- file.path(datadir, 'tas_annual_esm_rcp_r2i1p1_timeofrun.nc')
infileP <- file.path(datadir, 'pr_annual_esm_rcp_r2i1p1_timeofrun.nc')
...
```{r readdata}
filenameT <- file.path(datadir, 'tas_annual_esm_rcp_r2i1p1_timeofrun.nc')
...
filenameP <- file.path(datadir, 'pr_annual_esm_rcp_r2i1p1_timeofrun.nc')
